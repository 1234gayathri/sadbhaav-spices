      ...
      {products.length === 0 ? (
        <section className="py-20 text-center max-w-lg mx-auto px-6">
          <div className="rounded-3xl border border-dashed bg-card/30 p-10 flex flex-col items-center">
            ...
            <h2 className="font-display text-2xl font-semibold">Welcome to Sadbhaav Spices</h2>
            <p className="mt-3 text-sm text-muted-foreground">
              Your store is completely set up and ready to go! Start adding your premium, organic farm-fresh spices through the administration dashboard.
            </p>
            <Link
              to="/admin/products"
              className="mt-6 inline-flex rounded-full bg-accent px-6 py-3 text-sm font-semibold text-accent-foreground hover:opacity-90 transition"
            >
